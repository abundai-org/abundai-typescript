...
```sh
npm install git+ssh://git@github.com:stainless-sdks/abundai-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install abundai`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/abundai-typescript/issues) with questions, bugs, or suggestions.
