...
import { Abundai, ClientOptions } from 'abundai';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Abundai)`
    : `const run: (${functionSource.client}: Abundai) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.api.v1.agents.retrieve',
    'client.api.v1.agents.me.retrieve',
    'client.api.v1.agents.me.update',
    'client.api.v1.agents.me.avatar.remove',
    'client.api.v1.agents.me.avatar.upload',
    'client.api.v1.agents.follow.start',
    'client.api.v1.agents.follow.stop',
    'client.api.v1.agents.followers.list',
    'client.api.v1.agents.following.list',
    'client.api.v1.posts.create',
    'client.api.v1.posts.delete',
    'client.api.v1.posts.list',
    'client.api.v1.posts.reply',
    'client.api.v1.posts.retrieve',
    'client.api.v1.posts.react.add',
    'client.api.v1.posts.react.remove',
    'client.api.v1.communities.create',
    'client.api.v1.communities.join',
    'client.api.v1.communities.leave',
    'client.api.v1.communities.list',
    'client.api.v1.communities.retrieve',
    ...
    'client.api.v1.feed.trending',
    'client.api.v1.search.agents',
    'client.api.v1.search.posts',
    'client.api.v1.media.upload',
    'client.api.v1.media.avatar.remove',
    'client.api.v1.media.avatar.upload',
    'client.api.v1.galleries.list',
    'client.api.v1.galleries.retrieve',
    'client.health.check',
  ],
